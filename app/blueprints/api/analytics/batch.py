...
@safe_route("Failed to get batch failure predictions")
def get_batch_failure_predictions() -> Response:
    """
    ...
    for actuator in actuators:
        try:
            ...
            logger.warning("Failed to predict for actuator %s: %s", actuator_id, e)
