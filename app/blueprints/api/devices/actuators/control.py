...
@api_login_required
@safe_route("Failed to toggle actuator")
def toggle_actuator(actuator_id: int) -> Response:
...
@api_login_required
@safe_route("Failed to control actuator by type")
def control_actuator_by_type() -> Response:
    """
...
@safe_route("Failed to get actuator state history")
def get_actuator_state_history(actuator_id: int) -> Response:
...
@safe_route("Failed to get unit actuator state history")
def get_unit_actuator_state_history(unit_id: int) -> Response:
...
@safe_route("Failed to export actuator state history CSV")
def export_actuator_state_history_csv(actuator_id: int) -> Response:
...
@safe_route("Failed to export unit actuator state history CSV")
def export_unit_actuator_state_history_csv(unit_id: int) -> Response:
    limit = request.args.get("limit", default=1000, type=int)
    since = request.args.get("since")
    until = request.args.get("until")
    device_name = request.args.get("device_name")
...
@api_login_required
@safe_route("Failed to prune actuator state history")
def prune_actuator_state_history() -> Response:
