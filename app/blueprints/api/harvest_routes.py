...
def create_harvest_report(plant_id):
    ...
    try:
        ...
        response = jsonify({"ok": False, "data": None, "error": {"message": f"Failed to create harvest report: {e!s}"}})
...
def get_harvest_report(harvest_id):
    ...
    try:
        ...
        response = jsonify(
            {"ok": False, "data": None, "error": {"message": f"Failed to retrieve harvest report: {e!s}"}}
        )
        response.status_code = 500
        return response
...
def list_harvest_reports():
    ...
    try:
        ...
        response = jsonify({"ok": False, "data": None, "error": {"message": f"Failed to list harvest reports: {e!s}"}})
        response.status_code = 500
        return response
...
def get_plants_for_unit(unit_id):
    ...
    try:
        ...
        response = jsonify({"ok": False, "data": None, "error": {"message": f"Failed to get plants: {e!s}"}})
        response.status_code = 500
        return response
...
def delete_plant(plant_id):
    ...
    try:
        ...
        response = jsonify({"ok": False, "data": None, "error": {"message": f"Failed to delete plant: {e!s}"}})
        response.status_code = 500
        return response
...
def get_unit_harvest_stats(unit_id):
    ...
    try:
        ...
        response = jsonify(
            {"ok": False, "data": None, "error": {"message": f"Failed to get harvest statistics: {e!s}"}}
        )
        response.status_code = 500
        return response
...
def compare_growth_cycles(unit_id):
    ...
    try:
        ...
        return jsonify(
            {"ok": False, "data": None, "error": {"message": f"Failed to compare growth cycles: {e!s}"}}
        ), 500
...
def compare_specific_harvests():
    ...
    try:
        ...
        return jsonify({"ok": False, "data": None, "error": {"message": f"Failed to compare harvests: {e!s}"}}), 500
...
def get_plant_type_performance(plant_type):
    ...
    try:
        ...
        return jsonify(
            {"ok": False, "data": None, "error": {"message": f"Failed to get plant type performance: {e!s}"}}
        ), 500
...
def get_unit_sensor_summaries(unit_id):
    ...
    try:
        ...
        if not device_repo:
            response = jsonify({"ok": False, "data": None, "error": {"message": "Device repository not available"}})
        ...
        response = jsonify({"ok": False, "data": None, "error": {"message": f"Failed to get sensor summaries: {e!s}"}})
        response.status_code = 500
        return response
...
def get_harvest_environment_stats(unit_id):
    ...
    try:
        ...
        if not start_date or not end_date:
            response = jsonify(
                {"ok": False, "data": None, "error": {"message": "start_date and end_date are required"}}
            )
            response.status_code = 400
            return response
        ...
        response = jsonify(
            {"ok": False, "data": None, "error": {"message": f"Failed to get environment statistics: {e!s}"}}
        )
        response.status_code = 500
        return response
...
def health_check():
    ...
    try:
        ...
        response = jsonify(
            {"ok": False, "data": None, "error": {"message": str(e), "status": HealthLevel.CRITICAL.value}}
        )
        response.status_code = 503
        return response
