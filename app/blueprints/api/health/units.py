...
def register_unit_routes(health_api: Blueprint):
    ...
    @safe_route("Failed to get units health")
    def get_all_units_health() -> Response:
        """
    ...
    @safe_route("Failed to get unit health metrics")
    def get_unit_health(unit_id: int) -> Response:
        """
