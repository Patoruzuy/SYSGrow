...
def get_throttle_config():
    ...
    try:
        ...
        return error_response(f"Failed to get throttle configuration: {str(e)}", 500)
...
def update_throttle_config():
    ...
    try:
        ...
        return error_response(f"Invalid configuration: {str(e)}", 400)
    except Exception as e:
        logger.exception("Error updating throttle configuration")
        return error_response(f"Failed to update throttle configuration: {str(e)}", 500)
...
def reset_throttle_config():
    ...
    try:
        ...
        return error_response(f"Failed to reset throttle configuration: {str(e)}", 500)
