...
def get_unit_card_data(
    ...
    try:
        ...
        stats = {
            ...
            "sensor_count": growth_repo.count_sensors_in_unit(unit_id) if hasattr(growth_repo, 'count_sensors_in_unit') else 0,
            "actuator_count": growth_repo.count_actuators_in_unit(unit_id) if hasattr(growth_repo, 'count_actuators_in_unit') else 0,
            "camera_active": growth_repo.is_camera_active(unit_id) if hasattr(growth_repo, 'is_camera_active') else False,
            "last_activity": growth_repo.get_unit_last_activity(unit_id) if hasattr(growth_repo, 'get_unit_last_activity') else None,
            "uptime_hours": growth_repo.get_unit_uptime_hours(unit_id) if hasattr(growth_repo, 'get_unit_uptime_hours') else 0
        }
