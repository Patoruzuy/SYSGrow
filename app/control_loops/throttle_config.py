...
class ThrottleConfig:
    ...
    def from_dict(cls, data: dict[str, Any]) -> "ThrottleConfig":
        ...
        return cls(
            temperature_interval_minutes=time_intervals.get(
                "temperature_minutes", time_intervals.get("temp_humidity_minutes", 30)
            ),
            humidity_interval_minutes=time_intervals.get(
                "humidity_minutes", time_intervals.get("temp_humidity_minutes", 30)
            ),
            ...
            pressure_interval_minutes=time_intervals.get(
                "pressure_minutes", time_intervals.get("light_pressure_minutes", 30)
            ),
