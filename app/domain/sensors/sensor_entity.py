...
class SensorType(str, Enum):
    ...
    def _missing_(cls, value: object) -> "SensorType | None":
        ...
        environmental_types = {
            "environment_sensor", "temperature", "temperature_sensor",
            "humidity", "humidity_sensor", "co2", "lux_sensor", "light",
            "light_sensor", "voc", "smoke_sensor", "pressure", "pressure_sensor",
            "air_quality", "air_quality_sensor",
        }
        plant_types = {
            "plant_sensor", "soil_moisture", "soil_moisture_sensor",
            "ph", "ec",
        }
...
class SensorEntity:
    ...
    _last_read_time: Optional[datetime] = None
    _error_count: int = 0
