...
class ModbusAdapter(ISensorAdapter):
    ...
    def _test_connection(self):
        ...
        try:
            ...
            result = self.modbus_client.read_holding_registers(self.register_address, count=1, unit=self.slave_id)
            if result.isError():
    ...
    def read(self) -> dict[str, Any]:
        ...
        try:
            ...
            result = self.modbus_client.read_holding_registers(
                self.register_address, count=self.register_count, unit=self.slave_id
            )
