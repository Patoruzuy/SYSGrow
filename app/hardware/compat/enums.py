...
if TYPE_CHECKING:
    from app.enums.device import ActuatorType as AppActuatorType, Protocol as AppProtocol
else:
    try:
        from app.enums.device import ActuatorType as AppActuatorType, Protocol as AppProtocol
...
def infra_to_app_actuator_type(value: str | InfraActuatorType) -> "AppActuatorType" | None:
