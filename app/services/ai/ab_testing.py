        ...
        try:
            ...
            for test_data in tests:
                test = ABTest(
                    ...
                    start_date=datetime.fromisoformat(test_data["start_date"]) if test_data.get("start_date") else datetime.now(),
    ...
    def create_test(
        ...
        try:
            ...
            if not metadata_a or not metadata_b:
                raise ValueError(f"One or both versions not found in registry")
