...
class BayesianThresholdAdjuster:
    ...
    def __init__(
        self,
        irrigation_ml_repo: "IrrigationMLRepository" | None = None,
        workflow_repo: "IrrigationWorkflowRepository" | None = None,
        threshold_service: "ThresholdService" | None = None,
        default_prior_variance: float | None = None,
        min_variance: float | None = None,
        base_observation_variance: float | None = None,
    ...
    def update_from_feedback(
        ...
        *,
        ...
        posterior_mean = (
            prior_precision * belief.mean + observation_precision * observed_optimal
        ) / posterior_precision
        ...
        if self._notification_callback and abs(adjustment_amount) >= self._notification_tolerance:
            try:
