...
from infrastructure.database.repositories.personalized_learning import PlantConditionProfileRepository
...
class InfrastructureComponents:
    ...
    plant_condition_profile_repo: PlantConditionProfileRepository
...
class ContainerBuilder:
    ...
    def build_infrastructure(self) -> InfrastructureComponents:
        ...
        plant_condition_profile_repo = PlantConditionProfileRepository(database)
        ...
        return InfrastructureComponents(
            ...
            plant_condition_profile_repo=plant_condition_profile_repo,
    ...
    def build_optional_ai_components(
        ...
        if enable_personalized_learning:
            ...
            personalized_learning = PersonalizedLearningService(
                ...
                condition_profile_repo=infra.plant_condition_profile_repo,
            )
