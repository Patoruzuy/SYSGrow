...
from app.domain.actuators import ActuatorReading, ActuatorState
...
class StateTrackingService:
    ...
    def get_history(
        self, actuator_id: int, since: datetime | None = None, limit: int | None = None
    ...
    def get_stats(self, actuator_id: int) -> dict[str, Any]:
        ...
        on_start: datetime | None = since_24h if (prior and prior.state == ActuatorState.ON) else None
        on_seconds = 0.0
    ...
    def clear_history(self, actuator_id: int | None = None):
        """
        Clear history.
