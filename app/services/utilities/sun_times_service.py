...
class SunTimes:
    ...
    civil_twilight_begin: time | None = None
    civil_twilight_end: time | None = None
    nautical_twilight_begin: time | None = None
    nautical_twilight_end: time | None = None
    astronomical_twilight_begin: time | None = None
    astronomical_twilight_end: time | None = None
...
class SunTimesService:
    ...
    def _get_cached(self, cache_key: tuple[float, float, str]) -> SunTimes | None:
    ...
    def _parse_api_response(
        ...
        def parse_time(iso_str: str | None) -> time | None:
            if not iso_str:
                return None
            try:
    ...
    def set_location(self, latitude: float, longitude: float, timezone: str | None = None):
        """
...
# Singleton instance
_sun_times_service: SunTimesService | None = None
