...
def get_actuator_power_readings(actuator_id: int):
    ...
    try:
        ...
        readings = device_health.get_actuator_power_readings(
            actuator_id=actuator_id,
            limit=limit,
            hours=hours
        )
    ...
    try:
        ...
        dashboard = {
            ...
            "optimization": {
                ...
                "high_priority": len([r for r in recommendations if r.get('severity') in [RiskLevel.HIGH.value, AnomalySeverity.CRITICAL.value]]),
