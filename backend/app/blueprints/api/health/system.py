    ...
    def get_system_health():
        ...
        try:
            ...
            for unit_id, runtime in runtimes.items():
                ...
                controller_health = controller.get_health_status() if controller and hasattr(controller, "get_health_status") else {}
    ...
    def get_database_health():
        ...
        try:
            ...
            if db_file.exists():
                ...
                size_info["total_mb"] = round(
                    size_info["main_db_mb"] + size_info["wal_mb"] + size_info["shm_mb"], 2
                )
        ...
        try:
            ...
            metrics = {
                'caches': {
                    ...
                    'analytics': analytics_cache_stats
                },
                'recommendations': []
            }
