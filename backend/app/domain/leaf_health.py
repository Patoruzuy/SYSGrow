    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'indices': {
                ...
                'yellowness_index': round(self.yellowness_index, 3)
            }
        }
...
class LeafHealthAnalysis:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'ndvi_data': {
                'ndvi': self.ndvi,
                'chlorophyll_index': self.chlorophyll_index
            } if self.ndvi is not None else None,
...
class NDVIReading:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'timestamp': self.timestamp.isoformat(),
            'spectral_bands': {
                'red': round(self.red_reflectance, 3),
                'nir': round(self.nir_reflectance, 3)
            },
            'indices': {
                'ndvi': round(self.ndvi, 3),
                'chlorophyll_index': round(self.chlorophyll_index, 3)
            },
            'health_status': self.health_status.value
        }
