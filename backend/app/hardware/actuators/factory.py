...
from app.hardware.actuators.relays.wireless_relay import WirelessRelay
...
class ActuatorFactory:
    ...
    def __init__(self, mqtt_client: Any = None, event_bus: Optional[EventBus] = None):
        """
        Initialize factory.
