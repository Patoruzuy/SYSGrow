...
class EnergyMonitoringService:
    ...
    def register_power_profile(
        ...
        power_curve: Optional[Dict[int, float]] = None
    ) -> None:
        """
    ...
    def get_latest_reading(self, actuator_id: int) -> Optional[EnergyReading]:
    ...
    def get_consumption_stats(
        ...
        runtime_hours = sum(
            1 for r in readings if r.power and r.power > 0
        ) / (3600 / 60)  # Assuming 1-minute intervals
    ...
    def register_power_threshold_callback(
        self,
    ...
    def get_efficiency_metrics(self, actuator_id: int) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_energy_summary(self, energy_reading: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
