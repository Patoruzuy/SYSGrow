...
def test_stores_all_metrics_from_event(
    mock_control_logic, mock_analytics_repo, mock_polling_service
):
    """
...
def test_stores_multiple_events_from_different_sensors(
    mock_control_logic, mock_analytics_repo, mock_polling_service
):
    """
...
def test_excludes_metadata_keys(
    mock_control_logic, mock_analytics_repo, mock_polling_service
):
