...
def analytics_service(mock_analytics_repo, mock_device_repo, mock_growth_repo):
    ...
    service = AnalyticsService(
        repository=mock_analytics_repo, device_repository=mock_device_repo, growth_repository=mock_growth_repo
    )
    return service
...
class TestCachingFunctionality:
    ...
    def test_get_latest_sensor_reading_caches_result(self, analytics_service, mock_analytics_repo):
        ...
        # Arrange
        expected_reading = {"id": 1, "temperature": 23.5, "humidity": 65.0, "timestamp": datetime.now().isoformat()}
...
class TestEfficiencyScores:
    ...
    def test_calculate_environmental_stability_with_stable_conditions(
        self, analytics_service, mock_analytics_repo, mock_device_repo
    ):
    ...
    def test_calculate_environmental_stability_with_volatile_conditions(
        self, analytics_service, mock_analytics_repo, mock_device_repo
    ):
...
class TestServiceIntegration:
    ...
    def test_analytics_service_initializes_correctly(self, mock_analytics_repo, mock_device_repo):
        ...
        # Act
        service = AnalyticsService(repository=mock_analytics_repo, device_repository=mock_device_repo)
