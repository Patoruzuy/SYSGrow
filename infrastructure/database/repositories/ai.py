...
class AIHealthDataRepository:
    ...
    def get_sensor_time_series(
        ...
        Uses SensorReading for unit-level environmental metrics and PlantReadings
        for plant soil moisture.
        ...
        try:
            ...
            # Ensure any accidental soil_moisture in SensorReading doesn't override plant data.
            df = df.drop(columns=["soil_moisture"], errors="ignore")
