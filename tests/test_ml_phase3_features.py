...
class TestPhase3Integration:
    ...
    def test_trained_model_integration(self):
        ...
        mock_feature_engineer.extract_features.return_value = [
            45.0, 26.5, 50.0, 1.4, 600.0  # soil_moisture, temp, humidity, vpd, light
        ]
    ...
    def test_plant_specific_adjustment_factor(self):
        ...
        # Execute
        adjustment = predictor.get_adjustment_factor(
            plant_id=123,
            historical_feedback=plant_feedback
        )
